...
public class LogQueryEsDAO extends EsDAO implements ILogQueryDAO {
    ...
    public Logs queryLogs(final String serviceId,
      ...
      final BoolQueryBuilder query = buildQuery(serviceId, serviceInstanceId, endpointId, relatedTrace, startSecondTB, endSecondTB, tags, keywordsOfContent, excludingKeywordsOfContent);
      ...
      for (SearchHit searchHit : response.getHits().getHits()) {
        logs.getLogs().add(buildLog(searchHit));
      }
      return logs;
    }
  
    private BoolQueryBuilder buildQuery(String serviceId, String serviceInstanceId, String endpointId, TraceScopeCondition relatedTrace, long startSecondTB, long endSecondTB, List<Tag> tags, List<String> keywordsOfContent, List<String> excludingKeywordsOfContent) {
    ...
    private Log buildLog(SearchHit searchHit) {
      Log log = new Log();
