...
public class TraceQueryEsDAO extends EsDAO implements ITraceQueryDAO {
    ...
    final SearchBuilder search =
        Search.builder()
            .query(buildTraceQuery(startSecondTB, endSecondTB, minDuration, maxDuration, serviceId, serviceInstanceId,
                                   endpointId, traceId, traceState, tags))
    ...
    return buildTraceBrief(response);
  }

  private BoolQueryBuilder buildTraceQuery(long startSecondTB,
                                        long endSecondTB,
                                        long minDuration,
                                        long maxDuration,
                                        String serviceId,
  ...
  private TraceBrief buildTraceBrief(SearchResponse response) {
