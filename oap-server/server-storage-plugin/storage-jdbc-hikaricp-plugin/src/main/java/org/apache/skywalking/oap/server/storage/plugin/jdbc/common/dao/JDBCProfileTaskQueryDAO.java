...
public class JDBCProfileTaskQueryDAO implements IProfileTaskQueryDAO {
    ...
    for (final var table : tables) {
      results.addAll(queryTasksFromTable(table, serviceId, endpointName, startTimeBucket, endTimeBucket,
          limit));
    }
  ...
  @SneakyThrows
  private List<ProfileTask> queryTasksFromTable(String table, String serviceId, String endpointName,
      Long startTimeBucket, Long endTimeBucket, Integer limit) {
    ...
    appendTimeBucketConditions(sql, condition, startTimeBucket, endTimeBucket);
    appendServiceAndEndpointConditions(sql, condition, serviceId, endpointName);
  ...
  private void appendTimeBucketConditions(StringBuilder sql, ArrayList<Object> condition,
  ...
  private void appendServiceAndEndpointConditions(StringBuilder sql, ArrayList<Object> condition,
