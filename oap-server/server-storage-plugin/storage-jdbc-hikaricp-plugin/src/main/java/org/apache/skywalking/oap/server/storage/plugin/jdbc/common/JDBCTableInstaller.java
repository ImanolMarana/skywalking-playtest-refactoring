...
public class JDBCTableInstaller extends ModelInstaller {
    ...
    public void createOrUpdateTableIndexes(String table, List<ModelColumn> columns,
        ...
        createIdIndexIfApplicable(table, isAdditionalTable);

        createTableIndexIfApplicable(table, isAdditionalTable);

        createIndividualColumnIndexes(table, columns, jdbcClient);

        createCompositeIndexes(table, columns, columnNames, isAdditionalTable);
      }

      private void createCompositeIndexes(String table, List<ModelColumn> columns, Set<String> columnNames, boolean isAdditionalTable) throws SQLException {
        final var jdbcClient = (JDBCClient) client;
      ...
      private void createIndividualColumnIndexes(String table, List<ModelColumn> columns, JDBCClient jdbcClient) throws SQLException {
      ...
      private void createTableIndexIfApplicable(String table, boolean isAdditionalTable) throws SQLException {
        final var jdbcClient = (JDBCClient) client;
      ...
      private void createIdIndexIfApplicable(String table, boolean isAdditionalTable) throws SQLException {
        final var jdbcClient = (JDBCClient) client;
