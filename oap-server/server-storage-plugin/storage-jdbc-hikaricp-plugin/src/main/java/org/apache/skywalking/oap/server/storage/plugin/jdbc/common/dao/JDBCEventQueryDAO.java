...
public class JDBCEventQueryDAO implements IEventQueryDAO {
    ...
    protected Tuple2<Stream<String>, Stream<Object>> buildQuery(final EventQueryCondition condition) {
        ...
        addBasicConditions(conditions, parameters);

        addSourceConditions(condition, conditions, parameters);

        addEventConditions(condition, conditions, parameters);

        return Tuple.of(conditions.build(), parameters.build());
    }

    private void addBasicConditions(Stream.Builder<String> conditions, Stream.Builder<Object> parameters) {
        conditions.add(JDBCTableInstaller.TABLE_COLUMN + " = ?");
        parameters.add(Event.INDEX_NAME);
    }

    private void addSourceConditions(EventQueryCondition condition, Stream.Builder<String> conditions, Stream.Builder<Object> parameters) {
    ...
    private void addEventConditions(EventQueryCondition condition, Stream.Builder<String> conditions, Stream.Builder<Object> parameters) {
