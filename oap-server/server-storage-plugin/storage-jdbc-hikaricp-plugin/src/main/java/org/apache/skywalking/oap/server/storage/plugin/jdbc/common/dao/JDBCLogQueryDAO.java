...
public class JDBCLogQueryDAO implements ILogQueryDAO {
    ...
    protected SQLAndParameters buildSQL(
        ...
        appendJoinClause(tags, sql, tagTable);

        sql.append(" where ");
        sql.append(JDBCTableInstaller.TABLE_COLUMN).append(" = ?");
        parameters.add(LogRecord.INDEX_NAME);

        appendTimeBucketCondition(startSecondTB, endSecondTB, sql, parameters, table);
        appendServiceFilters(serviceId, serviceInstanceId, endpointId, sql, parameters, table);
        appendRelatedTraceCondition(relatedTrace, sql, parameters);
        appendTagFilters(tags, sql, parameters, tagTable);
    ...
    private void appendJoinClause(final List<Tag> tags, StringBuilder sql, String tagTable) {
    ...
    private void appendTimeBucketCondition(long startSecondTB, long endSecondTB, StringBuilder sql, List<Object> parameters, String table) {
    ...
    private void appendServiceFilters(String serviceId, String serviceInstanceId, String endpointId, StringBuilder sql, List<Object> parameters, String table) {
    ...
    private void appendRelatedTraceCondition(TraceScopeCondition relatedTrace, StringBuilder sql, List<Object> parameters) {
    ...
    private void appendTagFilters(final List<Tag> tags, StringBuilder sql, List<Object> parameters, String tagTable) {
