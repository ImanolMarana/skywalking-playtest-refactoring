...
public class AggregateLabelsOp {
    ...
    private static ExpressionResult aggregateLabeledValueResult(ExpressionResult expResult,
        ...
        groupedResult.forEach((labels, mqeValuesList) -> processMQEValuesList(expResult, factory, labels, mqeValuesList));
        return expResult;
    }

    private static void processMQEValuesList(ExpressionResult expResult, AggregateLabelsFuncFactory factory, List<KeyValue> labels, List<MQEValues> mqeValuesList) {
