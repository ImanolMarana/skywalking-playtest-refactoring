    ...
    private void retrieval(final Class<?> clazz,
        ...
        for (Field field : clazz.getDeclaredFields()) {
          if (field.isAnnotationPresent(Column.class)) {
            processColumnField(clazz, modelName, modelColumns, scopeId, checker, sqlDBModelExtension, banyanDBModelExtension, field);
          }
        }
      ...
      private void processColumnField(Class<?> clazz, String modelName, List<ModelColumn> modelColumns, int scopeId,
          ShardingKeyChecker checker, SQLDatabaseModelExtension sqlDBModelExtension,
          BanyanDBModelExtension banyanDBModelExtension, Field field) {
        ...
        SQLDatabaseExtension sqlDatabaseExtension = createSQLDatabaseExtension(field, column);
        ElasticSearchExtension elasticSearchExtension = createElasticSearchExtension(field);
        BanyanDBExtension banyanDBExtension = createBanyanDBExtension(banyanDBModelExtension, field, column);
        ...
        processAdditionalEntityAnnotation(sqlDBModelExtension, modelColumn, field);
      ...
      private void processAdditionalEntityAnnotation(SQLDatabaseModelExtension sqlDBModelExtension,
          ModelColumn modelColumn, Field field) {
        if (field.isAnnotationPresent(SQLDatabase.AdditionalEntity.class)) {
      ...
      private BanyanDBExtension createBanyanDBExtension(BanyanDBModelExtension banyanDBModelExtension, Field field,
          Column column) {
        ...
        return banyanDBExtension;
      }
    
      private ElasticSearchExtension createElasticSearchExtension(Field field) {
      ...
      private SQLDatabaseExtension createSQLDatabaseExtension(Field field, Column column) {
