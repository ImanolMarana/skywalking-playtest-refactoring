...
public class EndpointGroupingRuleReader {
    ...
    QuickUriGroupingRule read() {
        ...
        if (Objects.nonNull(yamlData)) {
            ...
            if (rulesData != null) {
                processRulesData(quickUriGroupingRule, rulesData);
            }
        }
    ...
    private void processRulesData(QuickUriGroupingRule quickUriGroupingRule, List rulesData) {
        rulesData.forEach(ruleObj -> {
            ...
            if (endpointRules != null) {
                processEndpointRules(quickUriGroupingRule, serviceName, endpointRules);
            }
        });
    }

    private void processEndpointRules(QuickUriGroupingRule quickUriGroupingRule, String serviceName, List endpointRules) {
