...
public enum FilterMatchers {
  ...
  private void processClassInfo(ClassPath.ClassInfo classInfo) throws IOException {
    ...
    if (plainFilterMatcher != null) {
      processPlainFilterMatcher(clazz, plainFilterMatcher);
    }

    if (booleanFilterMatcher != null) {
      processBooleanFilterMatcher(clazz, booleanFilterMatcher);
    }
  }

  private void processPlainFilterMatcher(Class<?> clazz, FilterMatcher plainFilterMatcher) {
  ...
  private void processBooleanFilterMatcher(Class<?> clazz, BooleanValueFilterMatcher booleanFilterMatcher) {
