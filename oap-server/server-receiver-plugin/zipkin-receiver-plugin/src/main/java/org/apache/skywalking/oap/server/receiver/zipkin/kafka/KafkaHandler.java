...
public class KafkaHandler {
  ...
  while (true) {
    try {
      ...
      logConsumerRecordsSize(consumerRecords);
      processConsumerRecords(consumerRecords);
    } catch (Exception e) {
...
private void logConsumerRecordsSize(ConsumerRecords<byte[], byte[]> consumerRecords){
  if (log.isDebugEnabled()) {
    log.debug(
...
private void processConsumerRecords(ConsumerRecords<byte[], byte[]> consumerRecords){
