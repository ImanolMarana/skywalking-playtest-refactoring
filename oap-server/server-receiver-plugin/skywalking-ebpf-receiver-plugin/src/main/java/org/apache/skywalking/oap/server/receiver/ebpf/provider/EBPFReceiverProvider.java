...
public class EBPFReceiverProvider extends ModuleProvider {
    ...
    loadOfficialAnalysis();
    startGrpcServer();

    registerGrpcHandlers();
  }

  private void loadOfficialAnalysis() throws ServiceNotProvidedException {
  ...
  private void startGrpcServer() throws ModuleStartException {
  ...
  private void registerGrpcHandlers() throws ServiceNotProvidedException {
    final var service =
