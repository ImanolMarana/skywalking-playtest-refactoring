...
public class ContinuousProfilingServiceHandler extends ContinuousProfilingServiceGrpc.ContinuousProfilingServiceImplBase implements GRPCHandler {
    ...
    try {
      handlePoliciesQuery(policiesQuery, responseObserver);
    } catch (Exception e) {
  ...
  private void handlePoliciesQuery(Map<String, String> policiesQuery, StreamObserver<Commands> responseObserver) throws StorageException {
    ...
    queryPoliciesFromCache(serviceIdList, policiesInDB);
  ...
  private void queryPoliciesFromCache(List<String> serviceIdList, HashMap<String, ContinuousProfilingPolicy> policiesInDB) {
